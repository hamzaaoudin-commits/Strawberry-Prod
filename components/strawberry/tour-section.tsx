  ...
  fr: {
    ...
    cta: "Commander l'architecture →",
        scenes: [
      {
        ...
        points: [
          "Exactement ce qu'une agence facture entre 10 000 et 40 000 € — et ce par quoi nous commençons",
          "Écrite à partir de ce que vous publiez déjà, pas d'un atelier où vous parlez pendant trois heures",
  ...
  en: {
    ...
    cta: "Order the architecture →",
        scenes: [
      {
        ...
        points: [
          "Exactly what an agency charges €10,000 to €40,000 for — and where we start",
          "Written from what you already publish, not from a workshop where you talk for three hours",
