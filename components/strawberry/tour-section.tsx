    ...
    scenes: [
      {
        ...
        points: ["Exactement ce qu'une agence facture entre 10 000 et 40 000 € — et ce par quoi nous commençons", "Écrite à partir de ce que vous publiez déjà, pas d'un atelier où vous parlez pendant trois heures", "Trois partis pris écrits en refus — ce que vous refusez, jamais ce que vous prétendez être"],
      ...
      },
      {
        ...
        points: ["Site, plaquette, discours commercial, emballage, fiche Google, avis clients — selon votre terrain", "Les contradictions entre deux de vos propres pages, celles que vous ne pouvez pas voir seul", "Ce que vous avez dit d'évident dans le questionnaire et qui n'apparaît nulle part dans vos supports"],
        href: "/marques-entreprises",
      },
      {
        k: "Pièce 03",
        ...
        points: ["Le mot que trois d'entre eux revendiquent déjà, et que vous devez cesser d'employer", "Celui que vous êtes seul à pouvoir tenir, avec la preuve que personne ne l'occupe", "Ce qui leur est structurellement indisponible — ce qu'ils ne pourraient pas copier même s'ils le voulaient"],
        href: "/marques-entreprises",
      },
      {
        k: "Pièce 04",
        ...
        points: ["Chacun chiffré : ce qu'il fait gagner, et ce qu'il vous fait perdre — nommé, pas caché", "Dans l'ordre, avec ce qu'il faut faire avant toute refonte visuelle", "Le premier mouvement — celui qui se fait dès demain et qui rend les suivants possibles"],
        href: "/marques-entreprises",
      },
      {
        k: "Pièce 05",
      ...
      },
      {
        ...
        points: ["Les mots à employer, ceux à cesser d'employer, et pourquoi — pour toute la maison", "Utilisables tels quels par vos équipes comme par votre outil IA : c'est écrit pour ça", "Un bloc à coller dans n'importe quel modèle de langage pour qu'il écrive dans votre voix — position, refus, mots interdits"],
        href: "/marques-entreprises",
      },
    ],
  },
    ...
    scenes: [
      {
        ...
        points: ["Exactly what an agency charges €10,000 to €40,000 for — and where we start", "Written from what you already publish, not from a workshop where you talk for three hours", "Three convictions written as refusals — what you refuse, never what you claim to be"],
        href: "/marques-entreprises",
      },
      {
        k: "Piece 02",
        ...
        points: ["Site, brochure, sales pitch, packaging, Google listing, reviews — depending on your ground", "The contradictions between two of your own pages, the ones you cannot see alone", "What you called obvious in the questionnaire and that appears nowhere in your own supports"],
        href: "/marques-entreprises",
      },
      {
        k: "Piece 03",
        ...
        points: ["The word three of them already claim, and that you must stop using", "The one only you can hold, with the proof that nobody occupies it", "What is structurally unavailable to them — what they could not copy even if they wanted to"],
        href: "/marques-entreprises",
      },
      {
        k: "Piece 04",
        ...
        points: ["Each one measured: what it gains and what it loses you — named, not hidden", "In order, with what to do before any visual rebrand", "The first move — the one you can make tomorrow, the one that makes the rest possible"],
        href: "/marques-entreprises",
      },
      {
        k: "Piece 05",
      ...
      },
      {
        ...
        points: ["Words to use, words to stop using, and why — for the whole house", "Usable as they are by your teams and by your AI tool: that is what they are written for", "A block to paste into any language model so it writes in your voice — position, refusals, banned words"],
        href: "/marques-entreprises",
      },
    ],
  },
