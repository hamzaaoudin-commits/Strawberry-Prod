...
const T = {
  en: {
    ...
    fmt: { sub: "Subscription", shot: "One-shot", post: "After the architecture" },
    featuredCta: "See the architecture →",
    cta: "Learn more →",
    ...
    rungs: [
      ...
      { key: "architecture", name: "BRAND NARRATIVE ARCHITECTURE", price: "4,500€", cadence: "one-time", fmt: "shot", answers: ["confused", "outgrown"], line: "BRAND NARRATIVE ARCHITECTURE. A complete repositioning — identity, position and language — impossible to confuse, impossible to generate.", href: "/brand-narrative-architecture", featured: true },
      { key: "momentum", name: "MOMENTUM", price: "2,500€", cadence: "/ month", fmt: "post", answers: ["execution"], line: "Creative direction + content execution, month by month. Once the architecture exists, the team that keeps telling your story — and carries it into the feed every day.", href: "/momentum" },
    ] as Rung[],
  },
  fr: {
    kicker: "L'Échelle",
    ...
    sub: "Quatre façons de travailler avec le studio, de 15€ par mois à l'architecture à 4 500€. Prenez celle qui correspond à où vous en êtes.",
    ...
    fmt: { sub: "Abonnement", shot: "One-shot", post: "Après l'architecture" },
    featuredCta: "Voir l'architecture →",
    cta: "En savoir plus →",
    ...
    rungs: [
      ...
      { key: "architecture", name: "BRAND NARRATIVE ARCHITECTURE", price: "4 500€", cadence: "one-shot", fmt: "shot", answers: ["confused", "outgrown"], line: "BRAND NARRATIVE ARCHITECTURE. Un repositionnement complet — identité, position et langage — impossible à confondre, impossible à générer.", href: "/brand-narrative-architecture", featured: true },
