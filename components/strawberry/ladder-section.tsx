...
const T = {
  ...
  fr: {
    ...
    rungs: [
      ...
      { key: "audit", name: "BRAND NARRATIVE AUDIT", price: "490€", cadence: "one-shot", fmt: "shot", answers: ["articulate", "confused"], line: "Un diagnostic écrit de ton récit actuel — ce qui porte, ce qui te brouille, et les mouvements à faire. Sept jours, sans appel.", href: "/audit" },
  ...
  es: {
    ...
    rungs: [
      ...
      { key: "audit", name: "BRAND NARRATIVE AUDIT", price: "490€", cadence: "pago único", fmt: "shot", answers: ["articulate", "confused"], line: "Un diagnóstico escrito de tu relato actual — lo que aterriza, lo que te difumina y los movimientos a realizar. Siete días, sin llamada.", href: "/audit" },
