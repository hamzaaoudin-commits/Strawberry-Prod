...
const T = {
  en: {
    ...
    messagePlaceholder: "Where are you today, and what would you like the market to understand about you?",
    sending: "Sending...",
    send: "Send Message \u2192",
  ...
  fr: {
    ...
    messagePlaceholder: "Où en êtes-vous aujourd'hui, et qu'aimeriez-vous que le marché comprenne de vous ?",
    sending: "Envoi...",
