...
const T = {
  en: {
    ...
    goals: ["Commission the Brand Narrative Architecture", "Commission the Brand Narrative Audit", "Subscribe to RADAR", "Find out if this is for me", "Other"],
  ...
  fr: {
    ...
    goals: ["Commander la Brand Narrative Architecture", "Commander le Brand Narrative Audit", "M'abonner à RADAR", "Savoir si c'est pour moi", "Autre"],
