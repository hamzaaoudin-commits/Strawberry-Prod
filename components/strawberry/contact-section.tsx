...
const T = {
  ...
  fr: {
    ...
    errRequired: "Merci de renseigner ton nom et ton message.",
    errEmail: "Merci de saisir une adresse email valide.",
    errThrottle: "Tu viens d'envoyer un message. Patiente {s}s avant d'en envoyer un autre.",
  },
  es: {
    kicker: "Escríbenos",
    h2a: "Habl",
    ...
    errRequired: "Introduce tu nombre y tu mensaje.",
    errEmail: "Introduce una dirección de email válida.",
