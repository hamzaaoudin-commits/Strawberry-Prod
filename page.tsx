...
export const metadata: Metadata = {
  title: "Brand Intelligence System — Strawberry Production",
  description:
    "A 45+ page intelligence report combining McKinsey-level market analysis with cinematic brand architecture. The strategic foundation every empire is built on.",
}
...
const INSIDE = [
  {
    title: "Brand Narrative Bible",
    desc: "Mission, vision, mythology, tone of voice, archetypes. Your business constitution — the document everything else flows from.",
  },
  {
    title: "Market Intelligence Report",
    desc: "TAM / SAM / SOM analysis. Where the money actually is, where you can realistically win, and what the next 24 months look like.",
  },
  {
    title: "Competitor Intelligence (Top 10)",
    desc: "Forensic breakdown of the ten players you'll be measured against. Positioning gaps, content strategies, pricing, weaknesses.",
  },
  {
    title: "4 Advanced Persona Profiles",
    desc: "Not demographics — psychographics. Beliefs, frustrations, status games, buying triggers. The people who will pay you.",
  },
  {
    title: "90-Day Go-To-Market Plan",
    desc: "Week-by-week execution roadmap. What to launch, in what order, with what message, on what channels.",
  },
  {
    title: "Content Territory Map",
    desc: "5 strategic pillars × 10 ideas each = 50 content angles you own. Never wonder what to post again.",
  },
]
    ...
    <main className="min-h-screen" style={{ background: "#0a0a0a", color: "#fff" }}>
      ...
      <section style={{ padding: "160px clamp(1.5rem,4vw,4rem) 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 980, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          >
            A 45+ page intelligence report combining McKinsey-level market analysis with cinematic brand architecture. This is
            not a brand guide — this is your business constitution.
          </p>
      ...
      <section style={{ padding: "100px clamp(1.5rem,4vw,4rem)", background: "#0d0d0d" }}>
        <div style={{ maxWidth: 980, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gap: 20, fontFamily: SANS, fontSize: 17, lineHeight: 1.8, color: "rgba(255,255,255,0.6)" }}>
            <p>
              Most founders post inconsistently because they&apos;re not sure what to say. They tweak their bio every two weeks
              because the positioning never quite lands. They look at competitors and feel both behind and indistinguishable.
            </p>
            <p>
              The real issue is upstream: no <em>strategic substrate</em>. No documented market map. No real persona work. No
              narrative spine. Just instinct and vibes — which works for a while, then stops scaling.
            </p>
            <p>
              The Brand Intelligence System is the document that ends that phase of your business.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "80px clamp(1.5rem,4vw,4rem)", background: "#0d0d0d" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h2 style={{ fontFamily: SERIF, fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 700, marginBottom: 32 }}>
            Three extras that usually cost extra.
          </h2>
      ...
      <section style={{ padding: "100px clamp(1.5rem,4vw,4rem)" }}>
        <div style={{ maxWidth: 980, margin: "0 auto" }}>
          ...
          >
            What changes 30 days after delivery.
          </h2>
      ...
      <section style={{ padding: "100px clamp(1.5rem,4vw,4rem)", background: "#0d0d0d" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h2 style={{ fontFamily: SERIF, fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 700, marginBottom: 28, lineHeight: 1.2 }}>
            2,500€ is not the cost. It&apos;s the floor.
          </h2>
          <p style={{ fontFamily: SANS, fontSize: 17, lineHeight: 1.8, color: "rgba(255,255,255,0.6)", marginBottom: 18 }}>
            A McKinsey junior bills this in 3 days. A branding agency would charge 15–25k for less depth and more buzzwords.
            We&apos;re positioned where the actual work is happening — at the founder level, with the kind of granularity
            you&apos;d only otherwise get by hiring full-time.
          </p>
          <p style={{ fontFamily: SANS, fontSize: 17, lineHeight: 1.8, color: "rgba(255,255,255,0.6)" }}>
            Most clients recoup it within the first quarter — usually from a single positioning shift that lets them raise
            prices or close a deal that was previously stuck.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "80px clamp(1.5rem,4vw,4rem)" }}>
        ...
        >
          ...
          <h2 style={{ fontFamily: SERIF, fontSize: "clamp(1.4rem, 2.5vw, 2rem)", fontWeight: 700, marginBottom: 16 }}>
            Two-week revision window.
          </h2>
          <p style={{ fontFamily: SANS, fontSize: 16, lineHeight: 1.7, color: "rgba(255,255,255,0.65)", margin: 0 }}>
            After delivery, you have 14 days of unlimited revisions. If something doesn&apos;t fit your reality, we rework it
            until it does. The deliverable is a living document, not a PDF you bury in Drive.
          </p>
        </div>
      </section>
