...
export const metadata: Metadata = {
  title: "Revenue Architecture System — Strawberry Production",
  description:
...
const INSIDE = [
  {
    ...
    desc: "Your offer rewritten as a decision, not a description. Pricing structure, anchoring, bonus stack — engineered to make the buy feel obvious.",
  },
  {
    title: "Sales Page Copywriting & Design",
    desc: "One long-form sales page, fully written and structured for design handoff. The page that does the closing while you sleep.",
  },
  {
    title: "Email Welcome Sequence",
    desc: "5–7 emails that introduce, frame, and convert. Built around your narrative — not a generic 'nice to meet you' drip.",
  },
  {
    title: "Trust-Building Nurture Sequence",
    desc: "Ongoing email cadence that keeps cold leads warm and warm leads buying. Stories, proofs, soft asks.",
  },
  {
    title: "Checkout Flow Optimization",
    desc: "Audit and rework of the checkout step itself — order bump, payment plan presentation, confirmation page upsell.",
  },
  {
    title: "Revenue Dashboard & KPIs",
    desc: "A single tracker for the metrics that actually matter: visitor-to-buyer rate, AOV, refund rate, LTV. No vanity numbers.",
  },
]
    ...
    <main className="min-h-screen" style={{ background: "#0a0a0a", color: "#fff" }}>
      ...
      <section style={{ padding: "160px clamp(1.5rem,4vw,4rem) 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 980, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          >
            The complete conversion infrastructure that turns your audience into customers. Funnels, offers, and sales
            systems engineered for maximum revenue.
          </p>
      ...
      <section style={{ padding: "100px clamp(1.5rem,4vw,4rem)", background: "#0d0d0d" }}>
        <div style={{ maxWidth: 980, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gap: 20, fontFamily: SANS, fontSize: 17, lineHeight: 1.8, color: "rgba(255,255,255,0.6)" }}>
            <p>
              Attention without conversion is the most expensive vanity metric in business. People follow you, like your
              posts, even tell you they love your work — and the revenue stays flat or oscillates randomly.
            </p>
            <p>
              The gap is structural. There&apos;s no offer architecture, no sales page doing the heavy lifting, no email
              sequence catching the people who almost bought. Every sale is hand-crafted, which means scaling means burning
              out.
            </p>
            <p>
              Revenue Architecture installs the missing infrastructure — so the audience you already have starts paying.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <h2 style={{ fontFamily: SERIF, fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", fontWeight: 700, letterSpacing: "-0.02em" }}>
              Six conversion pillars. One system.
            </h2>
          </div>
      ...
      <section style={{ padding: "100px clamp(1.5rem,4vw,4rem)" }}>
        <div style={{ maxWidth: 980, margin: "0 auto" }}>
          ...
          >
            What changes 60 days after launch.
          </h2>
      ...
      <section style={{ padding: "100px clamp(1.5rem,4vw,4rem)", background: "#0d0d0d" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h2 style={{ fontFamily: SERIF, fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 700, marginBottom: 28, lineHeight: 1.2 }}>
            2,500€ pays itself back in the first launch.
          </h2>
          <p style={{ fontFamily: SANS, fontSize: 17, lineHeight: 1.8, color: "rgba(255,255,255,0.6)", marginBottom: 18 }}>
            A direct-response copywriter charges 3–8k just for a sales page. A funnel agency charges 10–20k and ships
            templated work. We deliver the full conversion stack — page, sequences, checkout, tracking — for a fraction.
          </p>
          <p style={{ fontFamily: SANS, fontSize: 17, lineHeight: 1.8, color: "rgba(255,255,255,0.6)" }}>
            One closed deal in the first month — at the kind of pricing this system is built for — already covers it.
            Everything after is compounding margin.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "80px clamp(1.5rem,4vw,4rem)" }}>
        ...
        >
          ...
          <p style={{ fontFamily: SANS, fontSize: 16, lineHeight: 1.7, color: "rgba(255,255,255,0.65)", margin: 0 }}>
            Sales page copy, email sequences, and checkout flow each get a 14-day revision window. We tune the asset until it
            converts the way the model says it should.
          </p>
        </div>
      </section>
