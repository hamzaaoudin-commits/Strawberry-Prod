...
export const SAMPLE_DOC: Record<Lang, SampleDoc> = {
  fr: {
    ...
    partialTitle: "Ceci n'est qu'une partie de ce que tu recevras.",
    partialBody:
      "La commande complète compte quatorze pièces et représente environ quatre-vingt-dix pages. La page que tu lis en présente la structure intégrale — les quatorze pièces sont là — mais chacune est resserrée pour l'écran. Ce qui est retiré de cette édition web :",
    partialPoints: [
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "quote", text: "Le matin où tu défendras cette position pour la première fois devant quelqu'un qui te demandera en quoi tu es différente de BATIFLOW, tu n'auras pas besoin de mieux répondre : tu auras besoin de ne pas répondre à cette question-là. Ne plaide pas. Constate. Dis ce que tu as vu, dis ce que ça coûte, et laisse la personne en face reconnaître sa propre histoire — parce qu'elle en a une, et qu'elle n'a jamais entendu personne la nommer." },
    ],
  },
  {
    n: "06",
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "quote", text: "Ses mots, en privé : « Le pire, c'est que je sais que je l'ai fait. Je me rappelle le jour. Mais qu'est-ce que tu veux que je lui dise ? Que je m'en souviens ? Il s'en fout, lui, il a son architecte qui lui écrit des courriers. »" },
    ...
    ctaBody:
      "Le même travail, appliqué à la tienne, commence par une extraction qu'aucune machine ne peut automatiser : ta vérité, ta singularité, ce que tu ne vois plus parce que tu es dedans.",
  ...
  es: {
    ...
    partialBody:
      "El encargo completo consta de catorce piezas y unas noventa páginas. La página que estás leyendo presenta la estructura íntegra — las catorce piezas están aquí — pero cada una está condensada para la pantalla. Lo que esta edición web deja fuera:",
    partialPoints: [
    ...
    dossierRows: [
      ...
      ["El estado", "340 cuentas de pago. 47.000 € de ingreso mensual recurrente. Seis personas. Sin financiación."],
    ...
    parts: [
  {
    ...
    blocks: [
      ...
      { kind: "p", text: "Todo el valor real de SILLAGE está ausente de la frase que describe SILLAGE. La consecuencia es tarifaria: una frase fija una clase de referencia, y el precio nunca se negocia — se deduce de la categoría con la que te comparan. Archivada en productividad, SILLAGE vale dos horas semanales, que es exactamente el techo de 40 € contra el que choca." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "p", text: "Lo que rechazó aquel día no fue la suma, fue el marco. Había creído durante diez años ejercer un oficio donde se juzga lo que construyes. Descubrió un oficio donde se juzga lo que puedes establecer — y la diferencia se paga al contado, siempre por quien trabajó bien y archivó mal." },
      ...
      { kind: "list", items: [
        ...
        "Persiste porque nadie cuenta: el coste se reparte entre repasos no facturados, horas de gerente y relaciones dañadas. Invisible en las cuentas, luego nunca combatido.",
      ]},
      ...
      { kind: "quote", text: "La construcción se cuenta como un oficio donde se juzga lo que construyes, y funciona como un oficio donde se juzga lo que puedes establecer. SILLAGE nació de esa constatación — no como una herramienta más para llevar la obra mientras transcurre, sino como la casa que constituye la prueba de lo que se hizo, para que el día en que alguien impugne no haya nada que defender de memoria, solo un expediente que abrir." },
    ],
  },
  {
    n: "03",
    ...
    blocks: [
      ...
      { kind: "pair", beforeLabel: "Falso", afterLabel: "Correcto", before: "En un contexto donde la trazabilidad se convierte en un reto mayor para los actores de la construcción, resulta esencial poder demostrar la conformidad de los trabajos ejecutados.", after: "Sabes que tienes razón. No puedes demostrarlo. Pagas." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "table", head: ["Territorio", "Cadencia", "Ángulo de ejemplo"], rows: [
        ...
        ["La asimetría", "Mensual", "«Él tiene ocho meses para preparar. Tú tienes el miércoles por la noche»"],
      ...
      { kind: "list", items: [
        ...
        "Del accidente al vencimiento — 91 expedientes sobre 300 cuentas en doce meses. Uno no se asegura contra un accidente, se prepara para un vencimiento.",
      ...
      { kind: "p", text: "Siete piezas fechadas, cada una con su superficie, extensión, pilar y el reencuadre que opera. El día 1 abre con una frase escuchada y no vende nada; el día 3 publica el cálculo completo que servirá de fuente durante tres meses; el día 7 recupera en frío a todos los prospectos de los últimos seis meses con el asunto «Tu última impugnación»." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "quote", text: "La mañana en que defiendas esta posición por primera vez ante alguien que te pregunte en qué te diferencias de BATIFLOW, no necesitarás responder mejor: necesitarás no responder a esa pregunta. No alegues. Constata. Di lo que viste, di lo que cuesta, y deja que la persona enfrente reconozca su propia historia — porque tiene una, y nunca ha oído a nadie nombrarla." },
    ],
  },
  {
    n: "06",
    ...
    blocks: [
      ...
      { kind: "list", items: [
        ...
        "«En nuestras trescientas cuentas hubo noventa y una en doce meses.»",
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "p", text: "Las cifras no se enuncian como rendimiento sino como verificación de una tesis. Noventa y un expedientes completos exportados sobre trescientas cuentas en doce meses: no es un indicador de uso, es la medida de la frecuencia real del evento sobre el que descansa toda la posición. Treinta por ciento en un año — la impugnación no es un accidente marginal, es un vencimiento estadístico." },
    ],
  },
  {
    n: "12",
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "quote", text: "Sus palabras, en privado: «Lo peor es que sé que lo hice. Recuerdo el día. Pero ¿qué quieres que le diga? ¿Que me acuerdo? A él le da igual, tiene a su arquitecto escribiéndole cartas.»" },
    ...
    ctaBody:
      "El mismo trabajo, aplicado a la tuya, empieza con una extracción que ninguna máquina puede automatizar: tu verdad, tu singularidad, eso que ya no ves porque estás dentro.",
