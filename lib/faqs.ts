...
export const FAQ_AUDIT: FaqSet = {
  en: [
    ...
    { icon: "clock", q: "How long does it take?", a: "7 to 14 days from onboarding to delivery. The document is ready to use the Monday after it lands." },
  ...
  fr: [
    ...
    { icon: "clock", q: "Combien de temps ça prend ?", a: "7 à 14 jours de l'onboarding à la livraison. Le document est exploitable dès le lundi qui suit." },
...
export const FAQ_AUDIT490: FaqSet = {
  fr: [
    { icon: "compare", q: "Quelle est la différence exacte avec BRAND NARRATIVE ARCHITECTURE ?", a: "L'audit à 999 € diagnostique : il vous dit où vous vous tenez, ce qui vous confond avec les autres et vers où aller. BRAND NARRATIVE ARCHITECTURE construit : elle écrit votre plateforme narrative, vos piliers, votre système de langage et le copy prêt à déployer. L'un est une lecture, l'autre est une architecture." },
    { icon: "arrowup", q: "Est-ce que je peux commander l'architecture après ?", a: "Oui, et les 999 € sont déduits si vous le faites dans les 60 jours. L'audit sert de premier tour de repérage — rien n'est perdu." },
  ...
  en: [
    { icon: "compare", q: "What exactly separates this from BRAND NARRATIVE ARCHITECTURE?", a: "The 999 € audit diagnoses: it tells you where you stand, what makes you indistinguishable, and where to go. BRAND NARRATIVE ARCHITECTURE builds: it writes your narrative platform, your pillars, your language system and the deployable copy. One is a read, the other is an architecture." },
    { icon: "arrowup", q: "Can I commission the architecture afterwards?", a: "Yes, and the 999 € is deducted if you do so within 60 days. The audit works as a first pass — nothing is wasted." },
