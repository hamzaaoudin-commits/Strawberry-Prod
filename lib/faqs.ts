...
export const FAQ_AUDIT490: FaqSet = {
  fr: [
    { icon: "compare", q: "Quelle est la différence exacte avec BRAND NARRATIVE ARCHITECTURE ?", a: "L'audit à 2 900 € diagnostique : il vous dit où vous vous tenez, ce qui vous confond avec les autres et vers où aller. BRAND NARRATIVE ARCHITECTURE construit : elle écrit votre plateforme narrative, vos piliers, votre système de langage et le copy prêt à déployer. L'un est une lecture, l'autre est une architecture." },
    { icon: "arrowup", q: "Est-ce que je peux commander l'architecture après ?", a: "Oui, et les 2 900 € sont déduits si vous le faites dans les 60 jours. L'audit sert de premier tour de repérage — rien n'est perdu." },
  ...
  en: [
    ...
    { icon: "arrowup", q: "Can I commission the architecture afterwards?", a: "Yes, and the 2 900 € is deducted if you do so within 60 days. The audit works as a first pass — nothing is wasted." },
