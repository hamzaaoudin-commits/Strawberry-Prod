...
export const FAQ_AUDIT: FaqSet = {
  ...
  fr: [
    ...
    { icon: "clock", q: "Combien de temps ça prend ?", a: "trois semaines de l'onboarding à la livraison. Le document est exploitable dès le lundi qui suit." },
...
export const FAQ_AUDIT490: FaqSet = {
  fr: [
    { icon: "compare", q: "Quelle est la différence exacte avec BRAND NARRATIVE ARCHITECTURE ?", a: "L'Architecture à 2 900 € diagnostique : il vous dit où vous vous tenez, ce qui vous confond avec les autres et vers où aller. BRAND NARRATIVE ARCHITECTURE construit : elle écrit votre plateforme narrative, vos piliers, votre système de langage et le copy prêt à déployer. L'un est une lecture, l'autre est une architecture." },
    { icon: "arrowup", q: "Est-ce que je peux commander l'architecture après ?", a: "Oui, et les 2 900 € sont déduits si vous le faites dans les 60 jours. L'Architecture sert de premier tour de repérage — rien n'est perdu." },
    { icon: "clock", q: "Combien de temps ça prend ?", a: "Trois semaines à compter de la réception de votre questionnaire, et livré le vingt et unième jour au plus tard. Le document arrive au jour 15, on le relit ensemble au jour 20." },
  ...
  en: [
    { icon: "compare", q: "What exactly separates this from BRAND NARRATIVE ARCHITECTURE?", a: "The 2 900 € audit diagnoses: it tells you where you stand, what makes you indistinguishable, and where to go. BRAND NARRATIVE ARCHITECTURE builds: it writes your narrative platform, your pillars, your language system and the deployable copy. One is a read, the other is an architecture." },
    { icon: "arrowup", q: "Can I commission the architecture afterwards?", a: "Yes, and the 2 900 € is deducted if you do so within 60 days. The Architecture works as a first pass — nothing is wasted." },
    { icon: "clock", q: "How long does it take?", a: "Three weeks from receipt of your questionnaire, delivered on the twenty-first day at the latest. The document lands on day 15, we read it together on day 20." },
    ...
    { icon: "shield", q: "What if the diagnosis says everything is fine?", a: "It won't, and that isn't arrogance: no brand occupies a perfectly clean position. But if the Architecture concludes your positioning holds and the problem sits elsewhere — in your offer, your price, your distribution — we will say so, and we will tell you not to commission the next step." },
