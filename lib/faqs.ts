...
export const FAQ_AUDIT: FaqSet = {
  ...
  fr: [
    ...
    { q: "Comment se déroule le processus ?", a: "Une fois votre commande confirmée, vous recevez un questionnaire d'onboarding. Il prend 20 à 30 minutes et contient tout ce dont nous avons besoin pour bâtir votre architecture narrative de zéro." },
...
export const FAQ_RADAR: FaqSet = {
  en: [
    ...
    { q: "Will reading this fix my own positioning?", a: "No — and we would rather say so. RADAR trains your judgement so you can tell a real position from a slogan. Fixing your own is the commission, because the one brand you structurally can't read is yours." },
  ],
  fr: [
...
export const FAQ_MOMENTUM: FaqSet = {
  en: [
    ...
    { q: "The architecture is 4,500€ and MOMENTUM is 2,500€ a month. Am I paying twice?", a: "No. BRAND NARRATIVE ARCHITECTURE is one-shot: you pay 4,500€ once and own the architecture forever. MOMENTUM is monthly and entirely optional — it's the crew that keeps building, not a second copy of the blueprint." },
  ...
  fr: [
    ...
    { q: "L'architecture est à 4 500€ et MOMENTUM à 2 500€ par mois. Je paie deux fois ?", a: "Non. BRAND NARRATIVE ARCHITECTURE est one-shot : vous payez 4 500€ une fois et l'architecture est à vous pour toujours. MOMENTUM est mensuel et entièrement optionnel — c'est l'équipe qui continue de construire, pas une deuxième copie du plan." },
