...
const T = {
  ...
  fr: {
    ...
    h1a: "Les Manifestes",
    h1b: "Strawberry.",
    lead: "Neuf manifestes. Une doctrine. Un plan complet pour les marques qui refusent de disparaître dans la décennie de l'IA. Ouverts, gratuits, lisibles dans ton navigateur.",
    verbLabel: "Le verbe :",
    readVol: "Lire le Vol.",
    ctaH2: "Quand tu es prêt à bâtir.",
    ...
    volumes: [
      ...
      { title: "La Doctrine de la Tribu", verb: "Être suivi.", tagline: "Pourquoi réécrire le récit de ton entreprise est le seul moyen de survivre à la vague IA. Et comment bâtir une tribu qui ne disparaîtra pas avec elle." },
  ...
  es: {
    ...
    h1a: "Los Manifiestos",
    h1b: "Strawberry.",
    lead: "Nueve manifiestos. Una doctrina. Un plano completo para las marcas que se niegan a desaparecer en la década de la IA. Abiertos, gratuitos, legibles en tu navegador.",
    verbLabel: "El verbo:",
    readVol: "Leer el Vol.",
    ctaH2: "Cuando estés listo para construir.",
    ...
    volumes: [
      ...
      { title: "La Doctrina de la Tribu", verb: "Ser seguido.", tagline: "Por qué reescribir el relato de tu empresa es la única forma de sobrevivir a la ola de la IA. Y cómo construir una tribu que no desaparezca con ella." },
