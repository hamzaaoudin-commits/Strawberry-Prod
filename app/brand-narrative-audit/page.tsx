...
export default function BrandNarrativeAuditPage() {
  ...
  const [pillarsRef, pillarsVis] = useScrollReveal()
  const [processRef, processVis] = useScrollReveal()
  const [whomRef, whomVis] = useScrollReveal()
  const [investRef, investVis] = useScrollReveal()
  ...
  return (
    <main style={{ background: "#0a0a0a", color: "#fff", minHeight: "100vh", fontFamily: SANS, overflow: "hidden" }}>
      ...
      {/* HERO */}
      <section ref={heroRef as any} style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "120px clamp(1.5rem,4vw,4rem) 80px", position: "relative" }}>
        ...
        <div style={{ maxWidth: 1100, width: "100%", textAlign: "center", position: "relative", opacity: heroVis ? 1 : 0, transform: heroVis ? "translateY(0)" : "translateY(30px)", transition: "all 1s ease" }}>
      ...
      {/* PROBLEM */}
      <section ref={problemRef as any} style={{ padding: "120px clamp(1.5rem,4vw,4rem)", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", opacity: problemVis ? 1 : 0, transform: problemVis ? "translateY(0)" : "translateY(20px)", transition: "all 0.8s ease" }}>
      ...
      {/* PILLARS */}
      <section ref={pillarsRef as any} style={{ padding: "120px clamp(1.5rem,4vw,4rem)", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", opacity: pillarsVis ? 1 : 0, transform: pillarsVis ? "translateY(0)" : "translateY(20px)", transition: "all 0.8s ease" }}>
      ...
      {/* PROCESS */}
      <section ref={processRef as any} style={{ padding: "120px clamp(1.5rem,4vw,4rem)", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", opacity: processVis ? 1 : 0, transform: processVis ? "translateY(0)" : "translateY(20px)", transition: "all 0.8s ease" }}>
          <div style={{ textAlign: "center", marginBottom: 80 }}>
      ...
      {/* FOR WHOM */}
      <section ref={whomRef as any} style={{ padding: "120px clamp(1.5rem,4vw,4rem)", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", opacity: whomVis ? 1 : 0, transform: whomVis ? "translateY(0)" : "translateY(20px)", transition: "all 0.8s ease" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2rem,5vw,5rem)" }} className="for-whom-grid">
            <div>
      ...
      {/* INVESTMENT */}
      <section ref={investRef as any} style={{ padding: "120px clamp(1.5rem,4vw,4rem)", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", opacity: investVis ? 1 : 0, transform: investVis ? "translateY(0)" : "translateY(20px)", transition: "all 0.8s ease" }}>
      ...
      {/* FINAL CTA */}
      <section ref={ctaRef as any} style={{ padding: "140px clamp(1.5rem,4vw,4rem)", borderTop: "1px solid rgba(255,255,255,0.07)", position: "relative" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative", opacity: ctaVis ? 1 : 0, transform: ctaVis ? "translateY(0)" : "translateY(20px)", transition: "all 0.8s ease" }}>
