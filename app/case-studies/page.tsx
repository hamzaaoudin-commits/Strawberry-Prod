...
const CASE_STUDIES = [
  {
    ...
    how: "The Audit named what Vellum actually did — not a 'collaborative workflow tool' but the operating layer for product teams that refuse to drown in tickets. Founder archetype was rewritten. Enterprise tier got its own narrative spine. The 90-day doctrine sequenced the first three months of sales conversations.",
  ...
  },
  {
    ...
    before: "Posting consistently for 18 months. Stagnant audience. Followers were peers, not buyers. No clear narrative, no recurring obsession the audience could attach to. Programs launched to crickets.",
    ...
    how: "The Audit isolated the one cultural tension Théo could own — that high-performers are coached by people who've never operated. His archetype was sharpened: not 'executive coach' but the founder-operator other founders bring in when therapy isn't the answer. The doctrine mapped what to say, in what order, for 90 days.",
  ...
  },
  {
    ...
    after: "Inbound pipeline value 4x over the quarter following delivery. Prospects DMing her using the exact phrasing from the narrative spine. Cold leads almost disappeared — the people who reached out had already self-qualified through the content.",
    how: "The Audit gave Marina the words she'd been circling for two years. Audience profiles named the specific shame, ambition, and posture of her buyers — three months later, those exact phrases were echoing back in her DMs. The 90-day doctrine front-loaded the foundational essays so the rest of the year could compound on them.",
...
const TESTIMONIALS = [
  ...
  {
    quote: "The narrative spine they wrote is now the founding document of the studio. Every brief starts there. Every hire reads it day one.",
    name: "Hugo Delarue",
    role: "Founder, Delarue Studio",
  },
  {
    quote: "Our Series A deck used three paragraphs lifted directly from the Audit. The investors said it was the clearest positioning they'd read all year.",
  ...
  {
    quote: "The audience profiles alone were worth the commission. I read them once and understood why three of my offers had failed.",
    name: "Julien Bessière",
    role: "Independent consultant",
  },
  {
    quote: "Six months after delivery, I still re-read the doctrine before every launch. Nothing else I've paid for has held up that long.",
    name: "Noémie Vannier",
      ...
      <section style={{ minHeight: "70vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "140px clamp(1.5rem,4vw,4rem) 80px", position: "relative" }}>
        ...
        <div style={{ maxWidth: 1000, width: "100%", textAlign: "center", position: "relative" }}>
          ...
          <p style={{ fontSize: "clamp(1rem,1.5vw,1.2rem)", color: "rgba(255,255,255,0.7)", maxWidth: 700, margin: "0 auto", lineHeight: 1.6 }}>
            Real founders, real businesses, real results from the Brand Narrative Audit. The work is measurable, the language is theirs.
          </p>
        </div>
      </section>
