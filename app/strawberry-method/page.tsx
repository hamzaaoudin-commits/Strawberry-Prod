...
const T = {
  ...
  es: {
    ...
    consequences: [
      ...
      "Sin Territorio — sin campo de batalla. Compites donde no puede ganar.",
    ...
    bridgeItalic: "El m\u00e9todo es la disciplina por la cual se hace el artefacto. El artefacto es lo que le lleva.",
    bridgeCta: "Ver el encargo →",
    ctaH2a: "Aplique S.T.R.A.W.",
    ctaH2b: "a su casa.",
    ctaLead: "La Brand Narrative Architecture es el m\u00e9todo, hecho operativo para su casa. Cuatro semanas. Cinco etapas. Una constituci\u00f3n.",
    ctaProduct: "Brand Narrative Architecture",
    ctaPrice: "4.500€",
