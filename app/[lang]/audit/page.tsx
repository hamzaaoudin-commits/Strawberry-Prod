...
const T = {
  fr: {
    ...
    bridgeP: "J'ai appliqué la méthode complète à une marque de démonstration, et j'ai publié le document. Vous pouvez lire exactement ce que produit ce travail avant de commander quoi que ce soit.",
