...
const T = {
  fr: {
    ...
    previewLead: "Voici trois extraits d'un audit réel, mené sur VERSO, une maison de reliure d'art. Les cinq blocs sont lisibles en entier, gratuitement.",
    previewHouse: "VERSO",
    previewHouseSub: "Reliure et édition d'art · Bordeaux",
  ...
  en: {
    ...
    previewLead: "Three excerpts from a full audit, run on VERSO, an art bindery. All five blocks are readable in full, free.",
    previewHouse: "VERSO",
    previewHouseSub: "Art binding and editions · Bordeaux",
  ...
  es: {
    ...
    previewLead: "Tres extractos de una auditoría completa, realizada sobre VERSO, una encuadernación de arte. Los cinco bloques son legibles enteros, gratis.",
    previewHouse: "VERSO",
    previewHouseSub: "Encuadernación y ediciones de arte · Burdeos",
    ...
    blocks: [
      ...
      { n: "02", t: "La autopsia de su frase", d: "Su frase de posicionamiento actual, diseccionada palabra por palabra. Lo que toma prestado del campo, dónde diluye, qué palabras están muertas al llegar porque todos las usan ya." },
      { n: "03", t: "Las palabras a retirar", d: "La lista precisa de términos que debes abandonar, extraídos de las frases reales de sus competidores. Y los que podrían volverse suyos." },
      ...
      { n: "05", t: "El veredicto", d: "Un párrafo. El diagnóstico más nítido posible sobre dónde se sitúa hoy su marca en la percepción de su mercado." },
    ],
    ...
    limits: [
      "No reescribe su relato de marca. Te dice qué falla y hacia dónde ir — no la formulación final.",
      ...
      "Se produce a partir de lo que envía. El encargo completo, en cambio, empiece por hacerte hablar largamente.",
    ],
    limitClose: "Si quiere que se construya la arquitectura y no solo que se diagnostique, ese es el encargo de 4.500€.",
    limitCta: "Ver BRAND NARRATIVE ARCHITECTURE →",
    forKicker: "Para quién",
    forYes: "Es para usted si",
    forNo: "No es para usted si",
    yes: [
      "Tiene una marca en marcha y siente que no se distingue lo suficiente",
      "Quiere saber qué falla antes de comprometer un presupuesto de refundación",
      "Tiene una duda concreta sobre su posicionamiento y quiere una lectura externa documentada",
      "Prepare una ronda, un lanzamiento o un reposicionamiento y quiere un estado de situación",
    ],
    no: [
      "Aún no ha lanzado — no hay nada que auditar",
      "Quiere que se escriba el relato por usted: eso es el encargo completo",
      "Busca un logo, una identidad visual o contenido",
    ...
    bridgeP: "Publicamos una auditoría completa, página a página. Puede leer con precisión lo que hace el documento antes de encargar una.",
