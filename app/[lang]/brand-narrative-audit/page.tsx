...
const T = {
  fr: {
    ...
    limits: [
      ...
      "Il est produit à partir de ce que vous envoyez. BRAND NARRATIVE ARCHITECTURE, elle, commence par vous faire parler longuement.",
    ],
    limitClose: "Si vous voulez qu'on bâtisse l'architecture et pas seulement qu'on la diagnostique, c'est BRAND NARRATIVE ARCHITECTURE.",
    ...
    no: [
      ...
      "Vous voulez qu'on écrive votre récit à votre place : c'est BRAND NARRATIVE ARCHITECTURE",
    ...
    priceTitle: "Un document, écrit pour votre maison.",
    priceBody: "Sans appel, sans devis, sans allers-retours. Vous payez, vous remplissez le questionnaire, vous recevez.",
    priceNote: "Déduit intégralement de BRAND NARRATIVE ARCHITECTURE si vous la commandez dans les 60 jours.",
    // — Bridge
  ...
  en: {
    ...
    limitClose: "If you want the architecture built and not merely diagnosed, that is BRAND NARRATIVE ARCHITECTURE.",
    ...
    priceTitle: "One document, written for your house.",
    priceBody: "No call, no quote, no back and forth. You pay, you fill in the questionnaire, you receive.",
    priceNote: "Deducted in full from BRAND NARRATIVE ARCHITECTURE if you commission it within 60 days.",
