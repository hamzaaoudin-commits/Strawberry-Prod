...
const T = {
  ...
  es: {
    ...
    previewLead: "Tres extractos de una auditoría completa, realizada sobre VERSO — una encuadernación de arte inventada para el ejercicio, para que ningún cliente sirva de escaparate. Los cinco bloques son legibles enteros, gratis.",
    previewHouse: "VERSO",
    previewHouseSub: "Encuadernación y ediciones de arte · Burdeos · casa de demostración",
