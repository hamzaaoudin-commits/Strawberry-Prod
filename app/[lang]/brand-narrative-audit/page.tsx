...
const T = {
  ...
  fr: {
    ...
    offerP2: "Je te fais parler, longuement, pour atteindre ce qui vous rend v\u00e9ritablement singulier \u2014 souvent ce que vous ne voyez plus parce que vous êtes dedans. Cette mati\u00e8re humaine, votre v\u00e9rit\u00e9, devient la fondation. Aucune IA ne peut la produire, parce qu'elle ne vous a pas v\u00e9cu.",
