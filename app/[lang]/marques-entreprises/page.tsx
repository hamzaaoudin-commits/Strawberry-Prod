...
const COPY: TerrainCopy = {
  ...
  fr: {
    ...
    "price.b.d": "On lit votre marque comme le fait votre marché : ce qu'elle raconte aujourd'hui, ce qu'on en retient, et les mouvements qui changent ça. Un document de vingt à trente pages, livré en trois semaines. La même Architecture que pour un lieu ou un nom propre.",
  ...
  en: {
    ...
    "st.hint": "Drag across",
    "price.b.d": "We read your brand the way your market does: what it says today, what people keep of it, and the moves that change that. A twenty to thirty page document, delivered in three weeks. The same Architecture as for a venue or a name.",
