...
const COPY: TerrainCopy = {
  ...
  fr: {
    ...
    "case.1.name": "Nike",
    "case.1.body": "A refusé de vendre des chaussures — elle vend une conviction sur le dépassement de soi, portée par les mêmes trois mots depuis 1988.",
    "case.2.name": "Coca-Cola",
    "case.2.body": "A refusé de se fragmenter en sous-marques concurrentes. Un siècle plus tard, c'est toujours le même rouge, la même promesse simple.",
    "case.3.name": "Picard",
    "case.3.body": "A refusé de concurrencer les primeurs sur le frais. Le surgelé, souvent traité comme un pis-aller, est devenu chez eux une identité assumée.",
  ...
  en: {
    ...
    "case.1.name": "Nike",
    "case.1.body": "Refused to sell shoes — it sells a conviction about pushing past your limits, carried by the same three words since 1988.",
    "case.2.name": "Coca-Cola",
    "case.2.body": "Refused to fragment into competing sub-brands. A century on, it's still the same red, the same simple promise.",
    "case.3.name": "Picard",
    "case.3.body": "Refused to compete with greengrocers on fresh produce. Frozen food, often treated as a compromise, became an identity in its own right.",
