...
const COPY: TerrainCopy = {
  ...
  fr: {
    ...
    "ex.1.b": "« Votre site dit \\u201esur mesure\\u201c onze fois. Vos trois concurrents aussi. Ce que vous appelez sur mesure — refuser une commande quand le budget impose l'aggloméré — n'apparaît nulle part. Vous vendez donc une promesse que tout le monde signe, et vous taisez le refus que personne d'autre ne tiendrait. »",
    "ex.2.k": "La carte du champ",
    "ex.2.b": "« Trois concurrents sur cinq revendiquent le mot \\u201eartisanal\\u201c. Deux revendiquent \\u201esur mesure\\u201c. Aucun ne revendique le délai — tous le subissent et s'en excusent. C'est le terrain vide : vous êtes les seuls à livrer en seize semaines et à l'assumer comme une conséquence, pas comme un défaut. »",
    "ex.3.k": "Le mouvement",
    "ex.3.b": "« Mouvement 1, à faire avant tout le reste : remplacer la phrase d'accueil par le refus. \\u201eNous refusons les commandes que nous ne pourrions pas signer dans dix ans.\\u201c Coût : une journée de réécriture. Ce que ça débloque : vos commerciaux cessent de défendre un prix, ils défendent une durée. »",
  ...
  en: {
    ...
    "ex.1.b": "\\u201cYour site says \\u2018bespoke\\u2019 eleven times. So do your three competitors. What you actually mean by bespoke — turning down an order when the budget forces chipboard — appears nowhere. You are selling a promise anyone can sign, and keeping quiet about the refusal nobody else would hold.\\u201d",
    "ex.2.k": "The map of the field",
    "ex.2.b": "\\u201cThree competitors out of five claim the word \\u2018artisanal\\u2019. Two claim \\u2018bespoke\\u2019. None claims the lead time — they all endure it and apologise for it. That is the empty ground: you are the only one delivering in sixteen weeks and owning it as a consequence rather than a flaw.\\u201d",
    "ex.3.k": "The move",
    "ex.3.b": "\\u201cMove 1, before anything else: replace the homepage line with the refusal. \\u2018We turn down orders we could not sign off on ten years from now.\\u2019 Cost: one day of rewriting. What it unlocks: your salespeople stop defending a price and start defending a duration.\\u201d",
