...
const COPY: TerrainCopy = {
  ...
  fr: {
    ...
    "tour.title": "Ce qu'on trouve quand une position est écrite.",
    "work.r1.k": "Studio de création",
    "work.r2.k": "Cabinet de conseil",
    "work.r3.k": "Éditeur de logiciel",
    "work.r4.k": "Atelier artisanal",
    "tour.1.line": "Le devis part sans un mot de justification — le prix n'a plus besoin d'être défendu.",
    "tour.1.d1": "Le moment — l'appel où l'on cesse de vous comparer et où l'on vous choisit",
    "tour.1.d2": "La preuve — un refus assumé que vos concurrents n'oseraient pas écrire",
    "tour.1.d3": "Le casting — le fondateur, l'équipe, le client type, et le client qu'on décline",
    "tour.1.d4": "Les rituels — ce qu'on répète à chaque proposition, et ce qu'on n'écrit jamais",
    "tour.2.line": "Trois commerciaux, une seule version. La même phrase, du site au premier rendez-vous.",
    "tour.2.d1": "Le moment — le brief interne où chacun cesse d'improviser sa version",
    "tour.2.d2": "La preuve — un discours identique quel que soit celui qui parle",
    "tour.2.d3": "Le casting — les équipes qui portent la parole, et celles qui la subissent",
    "tour.2.d4": "Les rituels — le vocabulaire de la maison, les mots interdits",
    "tour.3.d4": "Le mouvement qu'on garde pour la fin, la démonstration qu'on ne sort qu'à certains clients",
    "tour.4.line": "Un nouvel arrivant écrit un message client que personne n'a besoin de corriger.",
    "tour.4.d1": "Le moment — la deuxième semaine d'un recrutement, quand le ton est déjà juste",
    "tour.4.d3": "Le casting — celui qui intègre, celui qui relit, celui qui tranche",
  ...
  en: {
    ...
    "tour.title": "What you find when a position is written.",
    "work.r1.k": "Design studio",
    "work.r2.k": "Consultancy",
    "work.r3.k": "Software company",
    "work.r4.k": "Craft workshop",
    "tour.1.line": "The quote goes out without a word of justification — the price no longer needs defending.",
    "tour.1.d1": "The moment — the call where they stop comparing you and start choosing you",
    "tour.1.d2": "The proof — a refusal your competitors would not dare put in writing",
    "tour.1.d3": "The cast — the founder, the team, the ideal client, and the one you turn down",
    "tour.1.d4": "The rituals — what you repeat in every proposal, and what you never write",
    "tour.2.line": "Three salespeople, one version. The same sentence, from the site to the first meeting.",
    "tour.2.d1": "The moment — the internal briefing where everyone stops improvising their own version",
    "tour.2.d2": "The proof — the same story whoever is speaking",
    "tour.2.d3": "The cast — the teams who carry the words, and those who inherit them",
    "tour.2.d4": "The rituals — the house vocabulary, the forbidden words",
    "tour.3.d4": "The move kept for last, the demonstration shown only to certain clients",
    "tour.4.line": "A new hire writes a client message nobody needs to correct.",
    "tour.4.d1": "The moment — the second week of a new hire, when the tone is already right",
    "tour.4.d3": "The cast — who onboards, who proofreads, who settles ties",
