...
const COPY: TerrainCopy = {
  ...
  fr: {
    ...
    "ex.lead": "Trois passages d'un audit, sur une maison inventée pour l'exercice : LOAM, mobilier de bureau sur mesure, douze ans, quatorze personnes.",
  ...
  en: {
    ...
    "ex.lead": "Three passages from an audit, on a house invented for the exercise: LOAM, bespoke office furniture, twelve years, fourteen people.",
