...
const T = {
  en: {
    ...
    refusals: [
      { title: "We refuse to scale.", body: "No growing team, no associates, no plans for either. Every word delivered has been written here. AI scales infinitely. We do not. Every audit is read, mapped and written by hand — the discipline of an atelier that refuses to dilute its attention." },
    ...
    founderP3: "When you commission an audit, you commission the people who will write it. No account manager stands between you and the writing, no junior is substituted after signature, no scope is negotiated downward. The document you receive carries the name of whoever wrote it.",
  ...
  fr: {
    ...
    refusals: [
      { title: "Nous refusons de scaler.", body: "Pas d'\u00e9quipe, pas d'associ\u00e9s, aucun projet d'en avoir. Chaque mot livr\u00e9 dans une commande est \u00e9crit par nous. L'IA scale \u00e0 l'infini. Nous non. Chaque audit est lu, cartographi\u00e9 et \u00e9crit \u00e0 la main — c'est la discipline d'un atelier qui refuse de diluer son attention." },
      { title: "Nous refusons de travailler avec tout le monde.", body: "Un audit qui conclut « ne changez rien » est un audit r\u00e9ussi, et il arrive. Certains n'ont pas encore assez de mati\u00e8re \u00e0 lire. D'autres seraient mieux servis ailleurs. Nous le disons plut\u00f4t que de prendre le travail." },
    ...
    founderP3: "Quand vous commandez un audit, vous commandez ceux qui l'\u00e9criront. Aucun chef de projet ne s'interpose entre vous et l'\u00e9criture, aucun junior n'est substitu\u00e9 apr\u00e8s signature, aucun p\u00e9rim\u00e8tre n'est n\u00e9goci\u00e9 \u00e0 la baisse. Le document que vous recevez porte le nom de celui qui l'a \u00e9crit.",
