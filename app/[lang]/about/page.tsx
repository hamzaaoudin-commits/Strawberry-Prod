...
const T = {
  en: {
    ...
    refusals: [
      ...
      { title: "I refuse to work with everyone.", body: "Most inquiries do not become commissions. Some founders are not ready. Some are ready but for a different studio. We take on the houses whose convictions we believe we can defend properly, and we say so plainly when that is not the case." },
  ...
  fr: {
    ...
    refusals: [
      ...
      { title: "Nous refusons le mod\u00e8le agence.", body: "Pas de r\u00e9tainers, pas de d\u00e9rive de p\u00e9rim\u00e8tre, pas de facturation horaire, pas de chefs de projet. Chaque engagement est une commande — une architecture d\u00e9finie sur quatre semaines pour une seule maison, livr\u00e9e comme un document \u00e9ditorial unique. L'\u00e9conomie des agences optimise le volume. Ce studio optimise ce qui survit une d\u00e9cennie." },
    ...
    discipline: [
      ...
      { title: "La revue \u00e0 trente jours.", body: "Un mois apr\u00e8s la livraison, nous nous revoyons. Quatre-vingt-dix minutes, en visio ou en personne. La question que nous posons : qu'est-ce qui a chang\u00e9. Le document est l'artefact. La revue est le moment o\u00f9 il devient op\u00e9rationnel. L'IA n'a aucune m\u00e9moire de votre maison. Nous si." },
    ],
  ...
  es: {
    ...
    founderP2: "Strawberry Production es el estudio que yo habr\u00eda contratado. Un taller reducido, a plena atenci\u00f3n sobre cuatro casas por trimestre, escribiendo cada palabra a mano, rechazando el vocabulario del campo. El trabajo es editorial en su forma porque hereda una escuela francesa donde la escritura editorial nunca estuvo separada de la seriedad intelectual.",
    founderP3: "Cuando encarga el trabajo, encarga a quienes lo har\u00e1n. Ning\u00fan gestor de cuenta se interpone entre usted y la escritura, ning\u00fan junior se sustituye tras la firma, ning\u00fan alcance se negocia a la baja. El documento que recibe lleva el nombre de quien lo escribi\u00f3.",
    ...
    ctaP: "Un encargo por casa. Cuatro casas por trimestre. La pr\u00f3xima apertura se anuncia aqu\u00ed.",
    cta: "Ver el encargo \u2192",
