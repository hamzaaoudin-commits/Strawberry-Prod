...
const T = {
  en: {
    ...
    lead: "Everyone has become competent. In a market where quality no longer sets anyone apart, what remains is what only you can say. We write it — by hand, one founder, one offer, four grounds.",
    whyKicker: "Why this studio exists",
    whyH2: "This studio came out of something we could no longer ignore.",
    whyP1: "Watching brand documents go by, the same flaw kept coming back: they were competent, and interchangeable. Written by different agencies, for different houses, they said the same thing in the same words. AI did not create that problem — it made it industrial.",
    whyP2: "So the practice had to start from the opposite end: read what a house already publishes, count what it shares with its competitors, and write only what is left. That is this studio.",
    ...
    refusals: [
      { title: "We refuse to scale.", body: "No growing team, no associates, no plans for either. Every word delivered has been written here. AI scales infinitely. We do not. Every Architecture is read, mapped and written by hand — the discipline of an atelier that refuses to dilute its attention." },
    ...
    founderP2: "Strawberry Production is the studio I would have hired. A small atelier, working at full attention, writing every word by hand, refusing the vocabulary of the field. The work is editorial in shape because it inherits a French school where editorial writing was never separate from intellectual seriousness.",
    founderP3: "When you commission an Architecture, you commission the people who will write it. No account manager stands between you and the writing, no junior is substituted after signature, no scope is negotiated downward. The document you receive carries the name of whoever wrote it.",
    ...
    ctaP: "One Architecture, 2 900 €, delivered within three weeks. Same method, same price, whatever the ground.",
    cta: "See our offers \u2192",
  ...
  fr: {
    ...
    lead: "Tout le monde est devenu compétent. Dans un marché où la qualité ne distingue plus personne, ce qui reste, c'est ce que vous êtes seul à pouvoir dire. Nous l'écrivons — à la main, un fondateur, une seule offre, quatre terrains.",
    whyKicker: "Pourquoi ce studio existe",
    whyH2: "Ce studio est né d'un constat qu'on ne pouvait plus ignorer.",
    whyP1: "En regardant les documents de marque passer, un même défaut revenait : ils étaient corrects, et interchangeables. Écrits par des agences différentes, pour des maisons différentes, ils disaient la même chose avec les mêmes mots. L'IA n'a pas créé ce problème — elle l'a rendu industriel.",
    whyP2: "Il fallait donc une pratique qui commence par le contraire : lire ce qu'une maison publie déjà, compter ce qu'elle partage avec ses concurrents, et n'écrire que ce qui reste. C'est ce studio.",
    ...
    refusals: [
      { title: "Nous refusons de scaler.", body: "Pas d'\u00e9quipe, pas d'associ\u00e9s, aucun projet d'en avoir. Chaque mot livr\u00e9 dans une commande est \u00e9crit par nous. L'IA scale \u00e0 l'infini. Nous non. Chaque Architecture est lu, cartographi\u00e9 et \u00e9crit \u00e0 la main — c'est la discipline d'un atelier qui refuse de diluer son attention." },
      { title: "Nous refusons de travailler avec tout le monde.", body: "Une Architecture qui conclut « ne changez rien » est une Architecture r\u00e9ussi, et il arrive. Certains n'ont pas encore assez de mati\u00e8re \u00e0 lire. D'autres seraient mieux servis ailleurs. Nous le disons plut\u00f4t que de prendre le travail." },
      { title: "Nous refusons la facturation à l'heure.", body: "Pas de dérive de périmètre, pas de taux horaire, pas de chef de projet entre vous et l'écriture. L'offre porte un prix affiché et un périmètre écrit. L'économie des agences optimise le volume facturé. Ce studio optimise ce qui survit une décennie." },
    ...
    founderP2: "Strawberry Production est le studio que j'aurais engag\u00e9. Un atelier restreint, \u00e0 pleine attention sur quatre maisons par trimestre, \u00e9crivant chaque mot \u00e0 la main, refusant le vocabulaire du champ. Le travail est \u00e9ditorial dans sa forme parce qu'il h\u00e9rite d'une \u00e9cole fran\u00e7aise o\u00f9 l'\u00e9criture \u00e9ditoriale n'a jamais \u00e9t\u00e9 s\u00e9par\u00e9e du s\u00e9rieux intellectuel.",
    founderP3: "Quand vous commandez une Architecture, vous commandez ceux qui l'\u00e9criront. Aucun chef de projet ne s'interpose entre vous et l'\u00e9criture, aucun junior n'est substitu\u00e9 apr\u00e8s signature, aucun p\u00e9rim\u00e8tre n'est n\u00e9goci\u00e9 \u00e0 la baisse. Le document que vous recevez porte le nom de celui qui l'a \u00e9crit.",
    ...
    ctaP: "Une Architecture, 2 900 €, livr\u00e9 sous sept \u00e0 quatorze jours. M\u00eame m\u00e9thode, m\u00eame prix, quel que soit le terrain.",
    cta: "Voir nos offres \u2192",
            ...
            <div>
              <div style={{ position: "relative" }}>
                <Image
                  ...
                  priority={false}
                  className="block w-full object-cover grayscale [aspect-ratio:3/4] [object-position:center_85%] [filter:grayscale(100%)_contrast(1.05)]"
                />
