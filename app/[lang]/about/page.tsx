...
const T = {
  en: {
    ...
    refusals: [
      ...
      { title: "We refuse hourly billing.", body: "No scope creep, no hourly rate, no project manager between you and the writing. Every offer carries a published price and a written scope — including MOMENTUM, which is monthly but whose contents are fixed in advance and are not negotiable. Agency economics optimise billable volume. This studio optimises what survives a decade." },
  ...
  fr: {
    ...
    lead: "Strawberry Production est un studio de perception narrative bas\u00e9 \u00e0 Paris. Un fondateur. Quatre commandes par trimestre.",
    ...
    refusals: [
      ...
      { title: "Nous refusons la facturation \\u00e0 l'heure.", body: "Pas de d\\u00e9rive de p\\u00e9rim\\u00e8tre, pas de taux horaire, pas de chef de projet entre vous et l'\\u00e9criture. Chaque offre a un prix affich\\u00e9 et un p\\u00e9rim\\u00e8tre \\u00e9crit \\u2014 y compris MOMENTUM, mensuel, dont le contenu est fix\\u00e9 d'avance et ne se n\\u00e9gocie pas. L'\\u00e9conomie des agences optimise le volume factur\\u00e9. Ce studio optimise ce qui survit une d\\u00e9cennie." },
