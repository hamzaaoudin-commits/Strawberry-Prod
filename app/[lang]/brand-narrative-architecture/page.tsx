...
const T = {
  en: {
    ...
    sampleP: "A complete commission, published in the open \u2014 fourteen of the twenty parts you would receive today. It was published before the six department playbooks joined the offer; read it for the writing, not the final count.",
    sampleCta: "Read the SILLAGE document \u2192",
    sampleBadge: "Read before you commission",
    sampleMeta: "Fourteen of twenty parts \u00b7 Free \u00b7 No email required",
  ...
  fr: {
    ...
    sampleP: "Une commande compl\u00e8te, publi\u00e9e en clair \u2014 quatorze des vingt pi\u00e8ces que vous recevriez aujourd'hui. Elle a \u00e9t\u00e9 publi\u00e9e avant que les six playbooks par d\u00e9partement rejoignent l'offre : lisez-la pour l'\u00e9criture, pas pour le compte final.",
    sampleCta: "Lire le document SILLAGE \u2192",
    sampleBadge: "\u00c0 lire avant de commander",
    sampleMeta: "Quatorze des vingt pi\u00e8ces \u00b7 Acc\u00e8s libre \u00b7 Sans email",
