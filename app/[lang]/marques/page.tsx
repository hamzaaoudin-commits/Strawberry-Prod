 ...
 * La page d'accueil.
 *
 * La porte Marques — l'ancienne page d'accueil.
 *
 * Le choix entre Marques et THE ROOM se fait désormais en amont, sur la
 * page d'entrée du site : quelqu'un qui arrive ici a déjà choisi, la page
 * n'a plus à lui reposer la question.
 *
