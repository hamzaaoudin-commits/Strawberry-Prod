...
const T = {
  en: {
    ...
    ctaLead: "The narrative audit applies the first three letters to your case: we read, we map, we name. Seven to fourteen days, and you know what to change. The Architecture goes through all five.",
  ...
  fr: {
    ...
    ctaLead: "L'audit narratif applique les trois premi\u00e8res lettres \u00e0 votre cas : on lit, on cartographie, on nomme. Sept \u00e0 quatorze jours, et vous savez quoi changer. L'Architecture, elle, va jusqu'au bout des cinq.",
