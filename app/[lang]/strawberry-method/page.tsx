...
const T = {
  en: {
    ...
    ctaLead: "The narrative architecture goes through all five letters: it finds the soul, maps the territory, reframes the field, draws the architecture and states how to embody it. Three weeks, and you leave with what each step produced. The Architecture builds what the audit prescribes — the same five steps, carried through to the delivered pieces.",
  ...
  fr: {
    ...
    ctaLead: "L'architecture narrative parcourt les cinq lettres : il trouve l'âme, cartographie le territoire, recadre le champ, dessine l'architecture et dit comment l'incarner. Trois semaines, et vous repartez avec ce que chaque étape a donné. L'Architecture, elle, construit ce que l'audit prescrit — les mêmes cinq étapes, menées jusqu'aux pièces livrables.",
