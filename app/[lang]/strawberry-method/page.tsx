...
const T = {
  en: {
    ...
    ctaLead: "The narrative audit goes through all five letters: it finds the soul, maps the territory, reframes the field, draws the architecture and states how to embody it. Seven to fourteen days, and you leave with what each step produced. The Architecture builds what the audit prescribes — the same five steps, carried through to the delivered pieces.",
    ctaProduct: "The narrative audit",
    ctaPrice: "490 €",
    cta: "Order the audit →",
  ...
  fr: {
    ...
    ctaLead: "L'audit narratif parcourt les cinq lettres : il trouve l'âme, cartographie le territoire, recadre le champ, dessine l'architecture et dit comment l'incarner. Sept à quatorze jours, et vous repartez avec ce que chaque étape a donné. L'Architecture, elle, construit ce que l'audit prescrit — les mêmes cinq étapes, menées jusqu'aux pièces livrables.",
    ctaProduct: "L'audit narratif",
    ctaPrice: "490 €",
