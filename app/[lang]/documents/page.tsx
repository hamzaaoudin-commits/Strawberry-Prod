...
const T = {
  fr: {
    ...
    docs: [
      { name: "SILLAGE", sub: "Logiciel de chantier", kind: "BRAND NARRATIVE ARCHITECTURE · quatorze pièces", body: "Une commande complète, de la dissection du champ narratif jusqu'aux quatre-vingt-dix premiers jours de déploiement. C'est exactement ce que reçoit une maison qui commande l'architecture.", href: "/documents/sillage" },
  ...
  en: {
    ...
    docs: [
      { name: "SILLAGE", sub: "Construction software", kind: "BRAND NARRATIVE ARCHITECTURE · fourteen parts", body: "A complete commission, from the dissection of the narrative field to the first ninety days of deployment. It is exactly what a house commissioning the architecture receives.", href: "/documents/sillage" },
