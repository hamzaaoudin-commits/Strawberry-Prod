  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul style={{ listStyle: "none", padding: 0, margin: "16px 0", display: "flex", flexDirection: "column", gap: 8 }}>
          <li style={{ paddingLeft: 20, position: "relative" }}><span style={{ position: "absolute", left: 0, color: COLOR }}>✦</span> <strong>BRAND NARRATIVE AUDIT</strong> — document de diagnostic narratif, au prix de 490 € en paiement unique, livré sous sept (7) jours ouvrés à compter de la réception du questionnaire d&apos;entrée dûment complété par le Client. Cette prestation constitue un diagnostic écrit et n&apos;emporte ni refonte narrative, ni production de contenus, ni séance d&apos;échange. En cas de commande ultérieure d&apos;une Brand Narrative Architecture dans un délai de soixante (60) jours à compter de la livraison, le montant de 490 € est déduit du prix de cette dernière.</li>
...
export default function CGVPage() {
  ...
  return (
    <main style={{ background: "#0a0a0a", color: "#fff", minHeight: "100vh", fontFamily: SANS, overflow: "hidden" }}>
      ...
      <section style={{ padding: "180px clamp(1.5rem,4vw,4rem) 80px", position: "relative" }}>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center", position: "relative", transition: "all 0.8s ease" }}>
          ...
          <h1 style={{ textTransform: "uppercase", fontFamily: SERIF, fontSize: "clamp(2.25rem,5vw,3.75rem)", fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.005em", marginBottom: 24 }}>
            Conditions générales <br /><span style={{ background: `linear-gradient(135deg, ${COLOR}, #ff4d2e)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>de vente.</span>
          </h1>
