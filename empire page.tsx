...
const ENGINES = [
  {
    ...
    items: ["Full Brand DNA", "Archetype + mythology", "Narrative universe design", "Positioning against competitors", "Psychological audience mapping"],
  ...
  },
  {
    ...
    items: ["Cinematic content system (scripts, hooks, structure)", "90-day content universe", "Authority + contrarian + intimacy mapping", "Full storytelling ecosystem across platforms"],
  ...
  },
  {
    ...
    items: ["Full offer architecture (high-ticket included)", "Funnel design (lead → nurture → convert)", "Lead magnet + email system", "Conversion mapping across all touchpoints"],
...
const REPLACES = ["A strategist", "A copywriter", "A funnel builder", "A brand consultant", "A content agency", "Years of trial and error"]
      ...
      <section ref={ref1} style={{ padding: "120px clamp(1.5rem,4vw,4rem)", background: "#0d0d0d", opacity: vis1 ? 1 : 0, transform: vis1 ? "none" : "translateY(40px)", transition: "all 0.9s" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {["A narrative identity", "A content engine", "A revenue system", "A positioning advantage no competitor can copy quickly"].map((item, i) => (
